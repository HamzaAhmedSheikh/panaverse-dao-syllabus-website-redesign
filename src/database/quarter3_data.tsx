export const quarter3_data = [
  {
    ...
    subHeading: "Earn While You Learn Projects",
    subHeading2: "Build Full-Stack Next.js 13 Jamstack Templates:",
    description:
    ...
    subHeading3: "The Template Standard",
    heading2: "Build QraphQL APIs",
    description2:
